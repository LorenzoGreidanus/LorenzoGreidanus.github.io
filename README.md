...
| `leermiddelen/profiel.js` | De speelcode aan de kant van de leerling (`PROFIEL.code/avatar/zetAvatar/maak/koppel/sync`): verzamelt `lg-beste-*`, `lg-toren-campagne`, `lg-toren-*` vrij, `lg-klas` en `lg-niveau` uit localStorage en zet wat van de server komt weer terug; de kiezer voor de eigen avatar staat in de leeromgeving |
