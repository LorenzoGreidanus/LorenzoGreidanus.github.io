...
| `leermiddelen/avatar.js` | Een avatar per bijnaam (`AVATAR.svg(naam, maat)`): een blob in de vorm van het logo-op-hover uit het merkboek, merkkleur en gezichtje uit een hash van de naam, dus overal dezelfde. Staat bij elke naam met een score: klassementen, Klasquiz, Klasstrijd, klasoverzicht, eindkaart |
