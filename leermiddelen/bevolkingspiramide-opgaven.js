...
window.PIRAMIDES = [
  ...
  { land:'Filipijnen', soort:'groei', uit:'brede basis die langzaam smaller wordt: de groei neemt af', levensverwachting:72, geboorte:20, sterfte:7,
  ...
  { land:'Portugal', soort:'krimp', uit:'weinig kinderen en veel veertigers en vijftigers', levensverwachting:81, geboorte:8, sterfte:12,
    m:[2.0, 2.4, 2.5, 2.9, 3.6, 3.7, 3.0, 2.4, 1.3, 0.3], v:[1.9, 2.3, 2.4, 2.9, 3.8, 4.0, 3.4, 3.0, 2.1, 0.8] },
  { land:'Griekenland', soort:'krimp', uit:'smalle basis, brede groepen van 40 tot 60 en veel ouderen', levensverwachting:80, geboorte:8, sterfte:13,
