...
(function(g){
  var ITEMS = [
    /* hoeden: h1 tot h8 */
    { id:'h1', soort:'h', n:1, naam:'Kroon',          prijs:120, uit:'voor wie het klassement aanvoert' },
    { id:'h2', soort:'h', n:2, naam:'Tovenaarshoed',  prijs:90,  uit:'paars, met sterren' },
    { id:'h3', soort:'h', n:3, naam:'Ridderhelm',     prijs:110, uit:'met vizier' },
    { id:'h4', soort:'h', n:4, naam:'Piratenhoed',    prijs:110, uit:'met doodshoofd' },
    { id:'h5', soort:'h', n:5, naam:'Hoorntjes',      prijs:80,  uit:'een beetje ondeugend' },
    { id:'h6', soort:'h', n:6, naam:'Halo',           prijs:150, uit:'een engel, zogenaamd' },
    { id:'h7', soort:'h', n:7, naam:'Bloemenkrans',   prijs:70,  uit:'lente op je hoofd' },
    { id:'h8', soort:'h', n:8, naam:'Feestmuts',      prijs:50,  uit:'altijd jarig' },
    /* randen: r1 tot r5 */
    { id:'r1', soort:'r', n:1, naam:'Gouden ring',    prijs:100, uit:'een rand van goud' },
    { id:'r2', soort:'r', n:2, naam:'Vuurring',       prijs:160, uit:'oranje vlammen' },
    { id:'r3', soort:'r', n:3, naam:'Regenboog',      prijs:220, uit:'alle kleuren' },
    { id:'r4', soort:'r', n:4, naam:'IJsring',        prijs:160, uit:'koud blauw' },
    { id:'r5', soort:'r', n:5, naam:'Sterrenkrans',   prijs:200, uit:'sterren eromheen' },
    /* zwaarden voor Zwaardvechter: z1 tot z5 */
    { id:'z1', soort:'z', n:1, naam:'Vlammend zwaard', prijs:180, uit:'een oranje kling die gloeit' },
    { id:'z2', soort:'z', n:2, naam:'IJszwaard',       prijs:180, uit:'lichtblauw en koud' },
    { id:'z3', soort:'z', n:3, naam:'Gouden zwaard',   prijs:250, uit:'van puur goud' },
    { id:'z4', soort:'z', n:4, naam:'Lichtzwaard',     prijs:300, uit:'groen licht, zoemt niet' },
    { id:'z5', soort:'z', n:5, naam:'Houten oefenzwaard', prijs:40, uit:'doet net zo veel pijn, eerlijk waar' },
