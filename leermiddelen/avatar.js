...
window.AVATAR = (function(){
  ...
  function hoed(n, kleur){
    ...
    if (n === 3) return '<path d="M-20,-31 L-18,-62 Q0,-64 18,-62 L20,-31 Z" fill="#14224C" stroke="#F3EFE9" stroke-width="1.4" stroke-opacity=".45" stroke-linejoin="round"/><path d="M-31,-30 h62" stroke="#14224C" stroke-width="6" stroke-linecap="round"/><path d="M-31,-30 h62" stroke="#F3EFE9" stroke-width="1.2" stroke-opacity=".45" stroke-linecap="round" transform="translate(0,-2.4)"/><rect x="-19.5" y="-41" width="39" height="6" fill="#F26749"/><path d="M-13,-58 v14" stroke="#fff" stroke-width="3" stroke-linecap="round" opacity=".18"/>';
